...
public class RemoteDocumentSource extends AbstractDocumentSource {
    ...
    public RemoteDocumentSource(LogAdapter log, URI requestURI, String outputTpl, String outputPath, String swaggerOutput, String mustacheFileRoot, boolean useOutputFlatStructure) {
        super(log, outputPath, outputTpl, swaggerOutput, mustacheFileRoot, useOutputFlatStructure);
        LOG = Logger.getLogger(RemoteDocumentSource.class);
